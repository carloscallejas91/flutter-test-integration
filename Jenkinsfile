            ...
            steps {
                script {
                    withCredentials([file(credentialsId: "${GCP_CREDENTIALS_ID}", variable: 'GCP_KEY_FILE')]) {
                        // ADIÇÃO DE DEBUG: Adicionado 'ls -R' para listar todos os arquivos no workspace.
